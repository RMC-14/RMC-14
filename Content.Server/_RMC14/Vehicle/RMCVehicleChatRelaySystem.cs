...
public sealed class RMCVehicleChatRelaySystem : EntitySystem
{
    [Dependency] private readonly ISharedPlayerManager _player = default!;
    [Dependency] private readonly RMCVehicleSystem _vehicle = default!;
    ...
    private bool TryGetRelayTarget(EntityUid user, out EntityUid target)
    {
        ...
        if (TryComp(user, out RMCVehicleViewToggleComponent? viewToggle))
        {
        ...
        if (TryComp(user, out RMCVehicleViewportUserComponent? viewport) &&
