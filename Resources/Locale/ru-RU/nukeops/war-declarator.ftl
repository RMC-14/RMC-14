...
war-declarator-lone-default-message = Одиночный ядерный оперативник Синдиката объявляет о своём намерении уничтожить станцию при помощи ядерного устройства и призывает службу безопасности предпринять ничтожную попытку остановить его.
