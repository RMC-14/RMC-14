rmc-cloak-activate-self = Вы сливаетесь с окружающим миром.
rmc-cloak-activate-others = {$user} растворяется в воздухе!
rmc-cloak-deactivate-self = Вы проявляетесь обратно!
rmc-cloak-deactivate-others = {$user} появляется из неоткуда!
