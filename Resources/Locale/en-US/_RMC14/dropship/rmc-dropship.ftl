...
rmc-dropship-terminal-xeno-clueless = You stare cluelessly at the {$terminal}.
rmc-dropship-terminal-no-nearby-destinations = There are no dropship destinations near you!
rmc-dropship-terminal-dropship-inbound = There is already a dropship coming here!
rmc-dropship-terminal-dropship-present = There is already a dropship here!
rmc-dropship-terminal-not-primary = The shuttle is not responding to prompts; it looks like this is not the primary shuttle.
rmc-dropship-terminal-call-down-success = You call down one of the dropships to your location.
rmc-dropship-terminal-no-available-dropships = There are no available dropships! Wait a moment.
rmc-dropship-terminal-unknown-location = ???
rmc-dropship-terminal-remote-control-disabled = This dropship does not have remote-control enabled.
rmc-dropship-terminal-dropship-busy = This dropship is currently busy. Please try again later.
rmc-dropship-terminal-dropship-routed = This dropship is now on its way.
rmc-dropship-destination-unavailable = This destination is no longer available.
rmc-dropship-planetside-only = This shuttle can only route to planetside landing zones.
rmc-dropship-destination-reserved = This destination is reserved for restricted shuttle traffic.
rmc-dropship-destination-not-configured = This destination is not configured for restricted shuttle traffic.
rmc-dropship-destination-invalid-class = This destination cannot receive the current shuttle class.
rmc-dropship-destination-invalid-tags = This destination is not valid for the current shuttle policy.
rmc-dropship-destination-blocked-tags = This destination is blocked for the current shuttle policy.
rmc-dropship-destination-occupied = This destination is already occupied.
rmc-dropship-invalid-docking-footprint = The shuttle does not have a valid docking footprint.
rmc-dropship-no-compatible-docking-port = No compatible docking port is available for this shuttle.
rmc-dropship-clearance-port = This shuttle extends past the port-side landing clearance ({$shuttleSize} required, {$destinationSize} available).
rmc-dropship-clearance-starboard = This shuttle extends past the starboard landing clearance ({$shuttleSize} required, {$destinationSize} available).
rmc-dropship-clearance-aft = This shuttle extends past the aft landing clearance ({$shuttleSize} required, {$destinationSize} available).
rmc-dropship-clearance-forward = This shuttle extends past the forward landing clearance ({$shuttleSize} required, {$destinationSize} available).
