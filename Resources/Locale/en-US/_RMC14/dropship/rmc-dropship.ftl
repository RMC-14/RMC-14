...
rmc-dropship-ert-destination-unavailable = This destination is no longer available.
rmc-dropship-ert-planetside-only = This shuttle can only route to planetside landing zones.
rmc-dropship-ert-berth-reserved = This berth is reserved for emergency response traffic.
rmc-dropship-ert-destination-not-configured = This destination is not configured for emergency response shuttles.
rmc-dropship-ert-berth-invalid-class = This berth cannot receive the current emergency shuttle class.
rmc-dropship-ert-destination-invalid-team = This destination is not valid for the current response team.
...
rmc-dropship-ert-clearance-forward = This shuttle extends past the forward docking clearance ({$shuttleSize} required, {$berthSize} available).
