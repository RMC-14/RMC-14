...
rmc-dropship-berth-reserved = This berth is reserved for restricted shuttle traffic.
rmc-dropship-berth-not-configured = This destination is not configured as a restricted shuttle berth.
rmc-dropship-berth-invalid-class = This berth cannot receive the current shuttle class.
rmc-dropship-berth-invalid-tags = This destination is not valid for the current shuttle policy.
rmc-dropship-berth-blocked-tags = This destination is blocked for the current shuttle policy.
rmc-dropship-berth-occupied = This berth is already occupied.
...
rmc-dropship-clearance-port = This shuttle extends past the port-side docking clearance ({$shuttleSize} required, {$berthSize} available).
rmc-dropship-clearance-starboard = This shuttle extends past the starboard docking clearance ({$shuttleSize} required, {$berthSize} available).
rmc-dropship-clearance-aft = This shuttle extends past the aft docking clearance ({$shuttleSize} required, {$berthSize} available).
rmc-dropship-clearance-forward = This shuttle extends past the forward docking clearance ({$shuttleSize} required, {$berthSize} available).
