...
rmc-xeno-hive-alliance-formed-self = Our Queen set up an alliance with { $hive }!
rmc-xeno-hive-alliance-broken-self = Our Queen broke the alliance with { $hive }!
rmc-xeno-faction-alliance-formed-self = Our Queen set up an alliance with { $faction }!
rmc-xeno-faction-alliance-broken-self = Our Queen broke the alliance with { $faction }!
