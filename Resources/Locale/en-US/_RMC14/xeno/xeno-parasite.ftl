...
rmc-xeno-infect-success-mask = The parasite smashes against {$target}'s {$mask} and rips it off!
rmc-xeno-infect-success-helmet = The parasite smashes against {$target}'s {$helmet}!
