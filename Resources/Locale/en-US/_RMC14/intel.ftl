...
ent-RMCIntelDatabaseComputer = intel database computer
    .desc = An intel database computer used for consulting the current intel database.
...
rmc-intel-clue-safe = Crack open a safe in {$area}, the combination lock is {$code}.
