...
rmc-intel-clue-data-disk = A recovered {$intel} in {$area}. SIGINT decryption key: {$key}.
rmc-intel-clue-data-terminal = A protected {$intel} in {$area}. Upload password: {$password}.
rmc-intel-clue-safe = A secure safe in {$area}. Combination: {$code}.
