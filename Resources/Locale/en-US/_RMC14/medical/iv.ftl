cm-iv-attach-self-injecting = You attach {THE($iv)} to {$target}, injecting into {POSS-ADJ($target)}.
cm-iv-attach-others-injecting = {$user} attaches {THE($iv)} to {$target}, injecting into {POSS-ADJ($target)}.
cm-iv-attach-self-drawing = You attach {THE($iv)} to {$target}, taking blood from {POSS-ADJ($target)}.
cm-iv-attach-others-drawing = {$user} attaches {THE($iv)} to {$target}, taking blood from {POSS-ADJ($target)}.
