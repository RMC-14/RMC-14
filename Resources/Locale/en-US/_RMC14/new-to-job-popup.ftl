...
rmc-new-to-job-nurse = As a nurse, your job is to assist doctors and learn the basics of medicine, so don't stress it if you're not constantly working. You can ask a doctor to show you the basics, and usually they will be more than happy to teach you how to treat patients.
                                             ...
                                             You can use a health analyser on a person to check their damage types, health and some suggestions for treatment. When a person is below 100 health out of 200, they will enter 'crit', lying on the floor unconscious, and at 0 or below, they are dead. You can revive them with a defibrillator if their HP returns to over 0 through applying your topical supplies, and you can slow down their rotting (and reduce airloss damage when in crit) by performing CPR, clicking on them in 4-second intervals with nothing in hand.
