...
rmc-new-to-job-nurse = As a Nurse, your job is assist doctors and learn the basics of medical, so don't stress it if you're not constantly working. You can ask a doctor to show you the basics, and usually they will be more than happy to teach you how to treat patients.

                                             Your basic medical topical supplies are Gauze / Trauma Kits / Surgical Lines for treating Brute damage, and Ointment / Burn Kits / Synth Graft for treating Burn damage. Gauze and Ointment are basic supplies anyone can use, with Brute / Burn kits healing damage fast and effectively when used by people with medical training - Surgical Lines and Synth Grafts are infinite use and can treat brute and burn effectively, so your go to tools should be those. Taking Brute damage can cause bleeding, reducing a person's blood level - So, ensure you treat their brute fast and early to prevent major blood loss.

                                             You can also use chemicals to treat people, healing them over time after an initial dosage. These can cover damage numbers that your typical topical supplies will only partially cover. Bicaradine, Meralyne, and their combination (MeraBic) treats Brute - Kelotane, Dermaline, and their combination (KeloDerma) treat burns. Kelotane and Bicaradine overdose at 30 - 50 units, While Meralyne and Dermaline overdose at 15 - 25 units. Ensure you do not give people too many units of chems, or they will suffer negative effects.

                                             You can use a Health Analyzer on a person to check their damage types, health and some suggestions for treatment. When a person is below 100 health out of 200, they will enter 'crit', lying on the floor unconcious, and at 0 or below, they are dead. You can revive them with a defibrilator if their HP returns to over 0 through applying your topical supplies, and you can slow down their rotting (and reducing airloss damage when in crit) by performing CPR, clicking on them in 4 second intervals with nothing inhand.

rmc-new-to-job-rifleman = As a rifleman, you are the main fighting force of your squad, having numbers to bolster. You have strength, and less likelyhood to be captured by the enemy force, in numbers and proximity.
...
rmc-new-to-job-military-police = As an MP, your job is to enforce Marine Law (MLAW) and the Standard Operating Procedure (SOP) for the Marines. The details of which can be found in the guidebook, or in books vended from your gearing vendor, located to the left of the hypersleep room.

                                             After getting a feel for Mlaw and SOP, at the start of an operation, MPs are typically posted at requisitions, lower medical, and briefing hall – anywhere you would find a large concentration of Marines, to better keep order. If you notice behavior that stands out to you as unusual, it's a good idea to review the books again or ask your peers on the MP radio about the situation. The information you gain can help guide your actions. Usually, however, your mere presence will be enough to deter most issues. Keep an eye on the radio for signs of problems forming and respond accordingly to maintain tensions and prevent troublemakers from disrupting the ship's operations.

                                             If you, or another officer, make an arrest. The suspect will be brought to the brig for sentencing by the Military Warden or Chief of Military Police (CMP) in the holding cell, located just southwest of the main entrance; this is also where the regular cells are. From here, you have permanent confinement  – and the execution room to your west, and the armory for red alert ship conditions is to your north. Only the Warden and CMP can open this armory in standard ship codes, so ask them if you need access to store something.

                                             After the Marines deploy, your time will be spent patrolling the ship, assisting with logistical tasks, moving boxes of intelligence to the computer lab on the second floor, and helping with mortuary duties.
