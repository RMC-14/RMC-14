...
health-examinable-sentry-none = It's in pristine condition.

health-examinable-sentry-Blunt-10 = [color=yellow]{CAPITALIZE(SUBJECT($target))} has a few dents.[/color]
health-examinable-sentry-Blunt-25 = [color=orange]{CAPITALIZE(SUBJECT($target))} is a bit beat up.[/color]
health-examinable-sentry-Blunt-50 = [color=red]{CAPITALIZE(SUBJECT($target))} is very caved in![/color]
health-examinable-sentry-Blunt-75 = [color=crimson]{CAPITALIZE(SUBJECT($target))} is barely holding together![/color]

health-examinable-sentry-Slash-10 = [color=yellow]{CAPITALIZE(SUBJECT($target))} has a few scratches.[/color]
health-examinable-sentry-Slash-25 = [color=orange]{CAPITALIZE(SUBJECT($target))} is scratched up.[/color]
health-examinable-sentry-Slash-50 = [color=red]{CAPITALIZE(SUBJECT($target))} is covered in slash marks![/color]
health-examinable-sentry-Slash-75 = [color=crimson]{CAPITALIZE(SUBJECT($target))} is falling apart![/color]

health-examinable-sentry-Piercing-10 = [color=yellow]{CAPITALIZE(SUBJECT($target))} has a few holes.[/color]
health-examinable-sentry-Piercing-25 = [color=orange]{CAPITALIZE(SUBJECT($target))} has quite a few holes.[/color]
health-examinable-sentry-Piercing-50 = [color=red]{CAPITALIZE(SUBJECT($target))} is littered with holes![/color]
health-examinable-sentry-Piercing-75 = [color=crimson]{CAPITALIZE(SUBJECT($target))} is about to collapse![/color]

health-examinable-sentry-Heat-10 = [color=yellow]{CAPITALIZE(SUBJECT($target))} has spots of corrosion.[/color]
health-examinable-sentry-Heat-25 = [color=orange]{CAPITALIZE(SUBJECT($target))} is starting to corrode.[/color]
health-examinable-sentry-Heat-50 = [color=red]{CAPITALIZE(SUBJECT($target))} is almost melted![/color]
health-examinable-sentry-Heat-75 = [color=crimson]{CAPITALIZE(SUBJECT($target))} is barely recognizable![/color]

health-examinable-sentry-Shock-10 = [color=yellow]{CAPITALIZE(SUBJECT($target))} has been slightly worn away.[/color]
health-examinable-sentry-Shock-25 = [color=orange]{CAPITALIZE(SUBJECT($target))} has burn marks on {POSS-ADJ($target)} surface.[/color]
health-examinable-sentry-Shock-50 = [color=red]{CAPITALIZE(SUBJECT($target))} is heavily charred![/color]
