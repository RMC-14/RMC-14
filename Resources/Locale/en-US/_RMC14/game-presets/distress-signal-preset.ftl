...
cm-distress-signal-selfdestruct = [color=yellow]The ship was scuttled by emergency reactor overload. Marines and xenonids alike were consumed in the blast. No side can claim the vessel.[/color] [color=purple]Yet, the surface remains overrun, and the xenonids endure.[/color]
