...
cm-distress-signal-selfdestruct = [color=yellow]The ship was scuttled by emergency reactor overload. Marines and xenonids alike were consumed in the blast. No side can claim the vessel. The resulting burning wreckage sets off further explosions on the surface of the planet, obliterating it and rendering it utterly uninhabitable for life.[/color]
