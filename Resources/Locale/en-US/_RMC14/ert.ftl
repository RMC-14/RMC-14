...
rmc-distress-entity-colony-headset-name = colony headset
rmc-distress-entity-colony-headset-description = A standard headset used by colonists.
rmc-distress-entity-forecon-headset-name = UNMC SOF headset
rmc-distress-entity-forecon-headset-description = Issued exclusively to Marine Raiders and members of the UNMC's Force Reconnaissance.
rmc-distress-entity-paramarine-headset-name = paramarine headset
rmc-distress-entity-paramarine-headset-description = A sleek headset used by the RCM's Paramarines. Low profile enough to fit under any headgear.
rmc-distress-entity-paramarine-teamlead-headset-name = paramarine team leader's headset
rmc-distress-entity-paramarine-officer-headset-name = paramarine officer's headset
rmc-distress-entity-paramarine-officer-headset-description = A sleek headset used by the RCM's Paramarines. Low profile enough to fit under any headgear. This one is heavier with the weight of responsibility.
rmc-distress-entity-spp-airborne-headset-name = SPP 173/Airborne headset
rmc-distress-entity-spp-airborne-headset-description = A headset used by members of the 173rd Airborne Reconnaissance unit.
