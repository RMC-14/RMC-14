...
rmc-ert-discord-username = ERT Dispatch
rmc-ert-discord-title = ERT Request {$id} - {$state}
rmc-ert-discord-field-request-id = Request ID
rmc-ert-discord-field-state = State
rmc-ert-discord-field-requester = Requester
rmc-ert-discord-field-source = Source
rmc-ert-discord-field-via = Via
rmc-ert-discord-field-created = Created
rmc-ert-discord-field-reason = Reason
rmc-ert-discord-field-allowed-calls = Allowed Calls
rmc-ert-discord-field-selected-call = Selected Call
rmc-ert-discord-field-timing = Timing
rmc-ert-discord-field-warning = Warning
rmc-ert-discord-field-error = Error
rmc-ert-discord-empty = -
rmc-ert-discord-timing-dispatch = Dispatch at {$time}
rmc-ert-discord-timing-recruitment-ends = Recruitment ends at {$time}
rmc-ert-discord-timing-return-available = Return available at {$time}
rmc-ert-discord-round-pre-restart = pre-round lobby after server restart
rmc-ert-discord-round-pre = pre-round lobby for round {$round}
rmc-ert-discord-round-in = round {$round}
rmc-ert-discord-round-post = post-round {$round}
rmc-ert-discord-footer = {$server} ({$round})
