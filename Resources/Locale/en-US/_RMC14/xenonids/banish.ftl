# Manage Hive Options
rmc-hivemanagement-banish = Banish Xeno
rmc-hivemanagement-readmit = Readmit Xeno

# Banish System
rmc-banish-choose-xeno = Choose a xenomorph to banish:
...
# Readmit System
rmc-readmit-choose-xeno = Choose a xenomorph to readmit:
rmc-readmit-choose-xeno-prompt = Select a banished xenomorph to readmit to the hive.
rmc-readmit-title = Readmission
rmc-readmit-confirm = Are you sure you want to readmit {$name} to the hive?
rmc-readmit-success = {$name} has been readmitted to the hive.
rmc-readmit-no-valid-targets = No banished xenomorphs to readmit.
