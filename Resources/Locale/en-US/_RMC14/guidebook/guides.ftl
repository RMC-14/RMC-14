...
cm-guide-entry-rules-higher-standards = Command Higher Standards
cm-guide-entry-rules-lethal-force = Lethal Force
cm-guide-entry-rules-lethal-force-consequences = Lethal Force Consequences
cm-guide-entry-rules-protect-detainees = MP Protect Detainees
cm-guide-entry-rules-general-roleplay-standards = General Roleplay Standards
