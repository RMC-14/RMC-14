...
ghost-target-window-type-filter-button = Filter: {$type}
...
ghost-target-window-type-sort-by-button = Sort by: {$type}
ghost-target-window-type-sort-by-name-title = Name
ghost-target-window-type-sort-by-role-title = Role
