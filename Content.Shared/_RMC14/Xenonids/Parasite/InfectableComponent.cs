...
public sealed partial class InfectableComponent : Component
{
    ...
    {
        [Sex.Male] = new SoundCollectionSpecifier("RMCMalePreburstScreams", AudioParams.Default.WithVariation(0.125f)),
        [Sex.Female] = new SoundCollectionSpecifier("RMCFemalePreburstScreams", AudioParams.Default.WithVariation(0.125f))
    };
}
