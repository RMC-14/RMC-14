...
public sealed partial class RotaryPhoneComponent : Component
{
    ...
    [DataField, AutoNetworkedField]
    public SoundSpecifier? DialingSound = new SoundPathSpecifier("/Audio/_RMC14/Phone/dial.ogg", AudioParams.Default.AddVolume(4));

    [DataField, AutoNetworkedField]
    public SoundSpecifier? DialingIdleSound = new SoundPathSpecifier("/Audio/_RMC14/Phone/ring_outgoing.ogg", AudioParams.Default.AddVolume(4));

    [DataField, AutoNetworkedField]
    public SoundSpecifier? ReceivingSound = new SoundPathSpecifier("/Audio/_RMC14/Phone/telephone_ring.ogg", AudioParams.Default.AddVolume(4));
