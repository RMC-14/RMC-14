...
public abstract partial class SharedLinearMoverController
{
    ...
    private void InitializeInput()
    {
        ...
        CommandBinds.Builder
            ...
            .Register<SharedLinearMoverController>();

        SubscribeLocalEvent<LinearInputMoverComponent, ComponentInit>(OnInputInit);
        SubscribeLocalEvent<LinearInputMoverComponent, ComponentGetState>(OnMoverGetState);
        SubscribeLocalEvent<LinearInputMoverComponent, ComponentHandleState>(OnMoverHandleState);
        SubscribeLocalEvent<LinearInputMoverComponent, EntParentChangedMessage>(OnInputParentChange);
    ...
    private void OnInputInit(Entity<LinearInputMoverComponent> entity, ref ComponentInit args)
    {
    ...
    private void OnMoverGetState(Entity<LinearInputMoverComponent> entity, ref ComponentGetState args)
    {
        args.State = new LinearInputMoverComponentState()
        {
    ...
    protected void SetMoveInput(Entity<LinearInputMoverComponent> entity, MoveButtons buttons)
    {
    ...
    private void OnMoverHandleState(Entity<LinearInputMoverComponent> entity, ref ComponentHandleState args)
    {
        if (args.Current is not LinearInputMoverComponentState state)
            return;
        ...
        entity.Comp.RelativeEntity = EnsureEntity<LinearInputMoverComponent>(state.RelativeEntity, entity.Owner);
    ...
    private void OnInputParentChange(Entity<LinearInputMoverComponent> entity, ref EntParentChangedMessage args)
    {
        ...
        entity.Comp.LerpTarget = TimeSpan.FromSeconds(LinearInputMoverComponent.LerpTime) + Timing.CurTime;
        Dirty(entity.Owner, entity.Comp);
    }
    ...
    public virtual void SetSprinting(Entity<LinearInputMoverComponent> entity, ushort subTick, bool walking)
    {
    ...
    private void SetMoveInput(Entity<LinearInputMoverComponent> entity, ushort subTick, bool enabled, MoveButtons bit)
    {
    ...
    private void ResetSubtick(LinearInputMoverComponent component)
    {
    ...
    /// </summary>
    public void SetVelocityDirection(Entity<LinearInputMoverComponent> entity, Direction direction, ushort subTick, bool enabled)
    {
    ...
    private bool TryUpdateRelative(EntityUid uid, LinearInputMoverComponent mover, TransformComponent xform)
    {
    ...
    public Angle GetParentGridAngle(LinearInputMoverComponent mover)
    {
    ...
    {
        private readonly SharedLinearMoverController _controller;
        private readonly Angle _angle;

        public CameraRotateInputCmdHandler(SharedLinearMoverController controller, Direction direction)
        {
    ...
    private sealed class CameraResetInputCmdHandler : InputCmdHandler
    {
        ...
        public CameraResetInputCmdHandler(SharedLinearMoverController controller)
        {
            _controller = controller;
        }
    ...
    private sealed class MoverDirInputCmdHandler : InputCmdHandler
    {
        ...
        public MoverDirInputCmdHandler(SharedLinearMoverController controller, Direction dir)
        {
            _controller = controller;
            _dir = dir;
        }
    ...
    {
        private SharedLinearMoverController _controller;

        public WalkInputCmdHandler(SharedLinearMoverController controller)
        {
            _controller = controller;
        }
