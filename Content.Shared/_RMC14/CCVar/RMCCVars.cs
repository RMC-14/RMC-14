...
public sealed class RMCCVars : CVars
{
    ...
    public static readonly CVarDef<float> RMCAutoPrimaryLandingZoneMinutes =
        CVarDef.Create("rmc.auto_primary_landing_zone_minutes", 25f, CVar.REPLICATED | CVar.SERVER);
}
