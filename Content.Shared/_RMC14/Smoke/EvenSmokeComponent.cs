...
public sealed partial class EvenSmokeComponent : Component
{
    ...
    /// <summary>
    ///     The amount of times it should instantly spread after spawning, it subtracted from the <see cref="Range"/> after the initial spread is done.
    ///     Make sure the <see cref="Spawn"/> prototype does NOT have the <see cref="EvenSmokeComponent"/> if you set this higher than 0.
    /// </summary>
    /// <example>
    /// Range = 3 and InitialSpread = 2: It will instantly spread twice, then spread with a delay one more time.
    /// </example>
    [DataField]
