...
public sealed class XenoWordQueenSystem : EntitySystem
{
    ...
    private void OnXenoWordQueenBui(Entity<XenoWordQueenComponent> queen, ref XenoWordQueenBuiMsg args)
    {
        ...
        {
            _popup.PopupClient(Loc.GetString("cm-xeno-nobody-hear-you"), queen, queen, PopupType.LargeCaution);
            return;
        }
        ...
        if (xenos.Count <= 1)
        {
            _popup.PopupEntity(Loc.GetString("cm-xeno-nobody-hear-you"), queen, queen, PopupType.LargeCaution);
            return;
        }
        ...
        var headerText = Loc.GetString("cm-xeno-words-of-the-queen");
