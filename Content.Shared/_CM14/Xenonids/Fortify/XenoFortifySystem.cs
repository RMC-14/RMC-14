...
using static Content.Shared._CM14.Xenonids.Fortify.XenoFortifyComponent;
using static Content.Shared.Physics.CollisionGroup;

namespace Content.Shared._CM14.Xenonids.Fortify;
