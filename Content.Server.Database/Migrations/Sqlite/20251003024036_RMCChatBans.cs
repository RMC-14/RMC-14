        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    banned_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    expires_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    reason = table.Column<string>(type: "TEXT", nullable: false),
                    banning_admin_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    unbanning_admin_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    unbanned_at = table.Column<DateTime>(type: "TEXT", nullable: true),
