...
public sealed partial class CharacterPickerButton : ContainerButton
{
        ...
        bool simple = false)
    {
        ...
        if (profile.PreferredMap is { } preferredMap &&
            protoMan.TryIndex(preferredMap, out var mapProto) &&
            mapProto.TryGetComponent<RMCPlanetMapPrototypeComponent>(out _))
        {
            PreferredMapLabel.Text = Loc.GetString(
                "character-setup-gui-character-picker-button-preferred-map",
                ("map", mapProto.Name));
            PreferredMapLabel.Visible = true;
        }
        else
        {
            PreferredMapLabel.Visible = false;
        }
        ...
        else
        {
            ...
            EnabledCheck.OnToggled += args =>
            {
                ...
                EnabledCheck.Text = Loc.GetString(args.Pressed ? EnabledLoc : DisabledLoc);
            };
        }
    }
}
