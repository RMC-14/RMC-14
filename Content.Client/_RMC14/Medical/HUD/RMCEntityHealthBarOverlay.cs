...
/// <summary>
/// RMC health bar overlay used by HUDs that should see healthy targets.
/// </summary>
public sealed class RMCEntityHealthBarOverlay : Overlay
{
    ...
    /// <summary>
    /// Optional status icon filter inherited from the active RMC health HUD.
    /// </summary>
    public ProtoId<HealthIconPrototype>? StatusIcon;

    public RMCEntityHealthBarOverlay(IEntityManager entManager, IPrototypeManager prototype)
    {
