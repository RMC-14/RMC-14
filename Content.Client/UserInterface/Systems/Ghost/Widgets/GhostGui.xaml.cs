using Content.Client._RMC14.UserInterface.Systems.Ghost.Controls; // RMC14: using a custom window
...
{
    public RMCGhostTargetWindow TargetWindow { get; } // RMC14: using a custom window
    ...
    public GhostGui()
    {
        ...
        TargetWindow = new RMCGhostTargetWindow(); // RMC14: using a custom window
