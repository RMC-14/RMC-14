...
public sealed partial class MiscTab : Control
{
    ...
    public MiscTab()
    {
        ...
        var akimboModeEntries = new List<OptionDropDownCVar<int>.ValueOption>
        {
            new((int) GunAkimboMode.FireBoth, Loc.GetString("rmc-ui-akimbo-mode-both")),
            new((int) GunAkimboMode.AlternateHands, Loc.GetString("rmc-ui-akimbo-mode-alternate")),
            new((int) GunAkimboMode.KeepActiveHand, Loc.GetString("rmc-ui-akimbo-mode-keep")),
        };
        ...
        Control.AddOptionDropDown(RMCCVars.RMCAkimboMode, RMCAkimboMode, akimboModeEntries);
